<div align="center">
  ...
  <img src="https://img.icons8.com/?size=512&id=53379&format=png" width="120" height="120" alt="Hotel Taj Logo" />
...
```mermaid
graph TD
    A[Guest / Admin Browser] -->|HTTP / REST API| B[Express.js Node Backend]
    B -->|JWT Authentication| C[Security Middleware]
    C -->|Controllers| D[Booking & Room Service Engine]
    D -->|Mongoose ODM| E[(MongoDB Database)]
    B -->|Static Assets| F[HTML5 / CSS3 / Vanilla JS Frontend]
```
